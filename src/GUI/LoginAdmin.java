...
public class LoginAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        kolomuser.setFont(new java.awt.Font("Swis721 BT", 1, 12)); // NOI18N
        ...
        getContentPane().add(kolomuser, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 240, 250, 30));

        kolompassw.setBackground(new java.awt.Color(255, 210, 66));
        kolompassw.setFont(new java.awt.Font("Swis721 BT", 1, 12)); // NOI18N
        ...
        getContentPane().add(kolompassw, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 320, 250, 30));
        ...
        getContentPane().add(login, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 385, 170, 50));
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        try {
            ...
            String sql = "SELECT * FROM admin WHERE ID_User = ? AND Password = ?";
